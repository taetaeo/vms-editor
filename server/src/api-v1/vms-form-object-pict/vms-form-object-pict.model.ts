...
export type VmsFormObject = z.infer<typeof VmsFormPictObjectScheme>;

export const VmsFormPictObjectScheme = z.object({
...
export const GetVmsFormPictObjectSchema = z.object({
  findAllQuery: z.object({
    formId: commonValidations.formId,
  }),
  findByObjectIdQuery: z.object({
    formId: commonValidations.formId,
